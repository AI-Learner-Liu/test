...
def compute_pairwise_distances(embeddings_filename: str,
    ...
    """
    cluster_dir = os.path.join('/nvme/liuweichen/data_test', 'cluster')
...
#os.environ['GLEAMS_HOME'] = os.path.join(os.environ['HOME'],'GLEAMS-master/gleams')
embeddings_filename = os.path.join('/nvme/liuweichen/data_test/embed','embed_GLEAMS.npy')
metadata_filename = os.path.join('/nvme/liuweichen/data_test/embed','embed_GLEAMS.parquet')
compute_pairwise_distances(embeddings_filename,metadata_filename,charges = (2,5))
